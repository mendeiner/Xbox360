...
const CONSOLE_ID = 'ps4'

// ─── Curated rows ──────────────────────────────────────────────────────────────
const FEATURED = [
  'God of War', 'Bloodborne', 'Horizon Zero Dawn', 'Uncharted 4', "Marvel's Spider-Man",
  'The Last of Us', 'Red Dead Redemption 2', 'Persona 5', 'Nioh', 'Days Gone',
  'Death Stranding', 'Until Dawn', 'Detroit', 'Ghost of Tsushima', 'Final Fantasy XV',
]
      ...
      <div className="md:ml-[200px]">
        ...
        <div className="sticky top-[57px] z-30 bg-[#0f0f0f]/95 backdrop-blur border-b border-[#1e1e1e] px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2 flex-shrink-0 text-[#003791] font-black text-[15px] tracking-tight">
            ...
            <div className="relative flex-1">
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="w-full bg-[#1e1e1e] border border-[#2a2a2a] rounded-full px-4 py-2.5 text-[14px] font-medium outline-none focus:border-[#003791] transition-colors placeholder-gray-600 text-white"
              />
              {search && (
        ...
        <main className="pb-16">
          {(loading || dataLoading) ? (
            <div className="flex items-center justify-center h-40">
              <div className="w-6 h-6 border-2 border-[#003791] border-t-transparent rounded-full animate-spin" />
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-40 gap-2 text-gray-600">
              ...
              <button onClick={() => { setSearch(''); clearAll() }} className="text-xs text-[#003791] hover:text-white transition-colors">
                Limpar filtros
              </button>
            </div>
          ) : isGrid ? (
